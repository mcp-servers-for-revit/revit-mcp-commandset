...
### v2.1.0 (2025-09-23)
- 🔧 **AIResult优化**：明确Message字段说明，统一Response数据类型规范
- 🧹 **架构清理**：删除FamilyCreationDefaults类，将默认值移至FamilyInstanceService静态属性
- ⚡ **错误处理改进**：FamilyInstanceCreator改用标准异常抛出，替代Console.WriteLine

### v2.0.0 (2025-09-22)
- 🏗️ **双层架构重构**：完善Creator（核心）+ Service（智能）职责分离
- 🚀 **参数建议精简**：彻底优化族创建参数建议格式，提升AI理解效率
- 🔄 **重构完成**：清理Creator冗余建议功能，专注核心创建逻辑
...
*本文档随代码更新，反映最新架构和功能变更。如有疑问请参考源码或联系开发团队。*